-- Insert indicators for the main modules
DO $$
DECLARE
...
BEGIN
    ...
    INSERT INTO public.indicators (code, name, unit, section_id, order_index, has_quarterly_data, has_monthly_data, has_annual_data) VALUES 
    ('TO.1.1', 'N.º de chamadas de voz ORIGINADAS com resposta / SAÍDA (Outgoing)', 'N.º Chamadas', trafego_originado_id, 1, true, false, false),
    ('TO.1.1.1', 'Para o próprio operador (On-net)', 'N.º Chamadas', trafego_originado_id, 2, true, false, false),
    ('TO.1.1.2', 'Para outros operadores móveis nacionais (Off-net)', 'N.º Chamadas', trafego_originado_id, 3, true, false, false),
    ('TO.1.1.3', 'Operador da rede Fixa', 'N.º Chamadas', trafego_originado_id, 4, true, false, false),
    ('TO.1.1.4', 'Números curtos e números não geográficos', 'N.º Chamadas', trafego_originado_id, 5, true, false, false),
    ('TO.2.1', 'Minutos de comunicação de voz ORIGINADAS com resposta / SAÍDA (Outgoing)', 'Minutos', trafego_originado_id, 6, true, false, false),
    ('TO.2.1.1', 'Para o próprio operador móvel (On-net)', 'Minutos', trafego_originado_id, 7, true, false, false),
    ('TO.2.1.2', 'Para outros operadores nacionais (Off-net)', 'Minutos', trafego_originado_id, 8, true, false, false),
    ('TO.3.1', 'Número total de SMS enviados', 'N.º SMS', trafego_originado_id, 9, true, false, false),
    ('TO.4.1', 'Número total de MMS enviados', 'N.º MMS', trafego_originado_id, 10, true, false, false);
